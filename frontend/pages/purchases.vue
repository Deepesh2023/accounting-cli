...
function statusBadgeColor(s: PurchaseResponse) {
  ...
  <div>
    ...
    <UCard class="mb-4">
      <div class="flex flex-wrap items-end gap-3">
        ...
        <USelect v-model="filterParty" :items="[{label: 'All', value: ''}, ...parties.map(p => ({label: p.name, value: p.party_id}))]" size="sm" label="Supplier" />
            ...
            <tr v-for="s in filteredPurchases" :key="s.purchase_id" class="hover:bg-gray-50 border-b border-gray-200">
              ...
              <td class="p-2">
                <div class="flex gap-1">
                  <UButton size="sm" variant="ghost" color="primary" @click="viewPurchase(s)">View</UButton>
